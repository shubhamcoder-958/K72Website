    ...
    <div className="z-[4] flex fixed top-0 w-full items-start justify-between">
      <div className="lg:p-5 p-2">
        <div className="lg:w-36 w-24">
          <svg
            className="mix-blend-difference w-full"
      ...
      >
        <div
          ref={navGreenRef}
          className="bg-[#03FD50] transition-all absolute top-0 h-0 w-full"
        ></div>
        <div className="relative h-full lg:px-12 px-8 flex flex-col justify-center items-end lg:gap-1.5 gap-0.5">
          <div className="lg:w-20 w-14 h-0.5 bg-white"></div>
          <div className="lg:w-12 w-8 h-0.5 bg-white"></div>
        </div>
      </div>
    </div>
  );
